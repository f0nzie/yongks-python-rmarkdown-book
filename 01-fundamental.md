...
#:> Data of b = 123 
#:> Data of c = 123 
#:> ID of a =  140225218443744 
#:> ID of b =  140225218443744 
#:> ID of c =  140225218443744
```
...
#:> x =  same mem loc 
#:> y =  same mem loc 
#:> id(x) =  140224612919216 
#:> id(y) =  140224612919216
```
...
```
#:> id(a) =  140225142725680 
#:> id(b) =  140225142725680 
#:> a == b   True
```
...
```
#:> ID outside Function:  140224612980688
```
...
```
#:> [1, 2, 3, 4, 5]
#:> ID in Function:       140224612980688
```
...
```
#:> 140224613005584 140224613007264
```
...
#:> Convert to set      :  {'c', 'e', 'a', 'd', 'f', 'g', 'b'} 
#:> Convert back to list:  ['c', 'e', 'a', 'd', 'f', 'g', 'b']
```
...
```
#:> [<function foo at 0x7f88963f4710>, <function bar at 0x7f88963f44d0>]
```
...
```
#:> [<function foo at 0x7f88963fee60>, <function bax at 0x7f8896401200>]
```
...
```
#:> [<function bar at 0x7f8896401050>, <function bax at 0x7f8896401200>]
```
...
```
#:> datetime.datetime(2020, 10, 30, 11, 36, 31, 481464)
```
...
```
#:> datetime.datetime(2020, 10, 30, 16, 36, 31, 494848)
```
...
```
#:> datetime.datetime(2020, 10, 30, 11, 36, 31, 508326)
```
...
```
#:> datetime.datetime(1999, 10, 30, 11, 36, 31, 591189)
```
...
```
#:> delt+now :  2021-10-30 12:09:46.773738
```
...
#:> 0   C3   D3  G1  53.578257  25.799941
#:> 1   C1   D4  G2  48.833079  23.132702
#:> 2   C2   D1  G2  51.091219  19.347020
#:> 3   C2   D2  G1  43.362113  13.448023
#:> 4   C2   D5  G1  53.854502  20.114795
```
...
#:> 0     C3   D3  G1  53.578257  25.799941  53.578257
#:> 1     C1   D4  G2  48.833079  23.132702  48.833079
#:> 2     C2   D1  G2  51.091219  19.347020  51.091219
#:> 3     C2   D2  G1  43.362113  13.448023  43.362113
#:> 4     C2   D5  G1  53.854502  20.114795  53.854502
#:> ..   ...  ...  ..        ...        ...        ...
#:> 195   C1   D1  G1  48.473794  19.316015  48.473794
#:> 196   C2   D1  G1  41.861740  21.918258  41.861740
#:> 197   C3   D3  G2  57.297221  21.600648  57.297221
#:> 198   C1   D2  G2  46.270898  16.137928  46.270898
#:> 199   C3   D4  G2  51.532306  20.975813  51.532306
#:> 
...
#:> 0     C3   D3  G1  53.578257  25.799941  53.578257  25.799941
#:> 1     C1   D4  G2  48.833079  23.132702  48.833079  23.132702
#:> 2     C2   D1  G2  51.091219  19.347020  51.091219  19.347020
#:> 3     C2   D2  G1  43.362113  13.448023  43.362113  13.448023
#:> 4     C2   D5  G1  53.854502  20.114795  53.854502  20.114795
#:> ..   ...  ...  ..        ...        ...        ...        ...
#:> 195   C1   D1  G1  48.473794  19.316015  48.473794  19.316015
#:> 196   C2   D1  G1  41.861740  21.918258  41.861740  21.918258
#:> 197   C3   D3  G2  57.297221  21.600648  57.297221  21.600648
#:> 198   C1   D2  G2  46.270898  16.137928  46.270898  16.137928
#:> 199   C3   D4  G2  51.532306  20.975813  51.532306  20.975813
#:> 
...
#:> 0     C3   D3  G1  53.578257  25.799941  107.156513
#:> 1     C1   D4  G2  48.833079  23.132702   97.666159
#:> 2     C2   D1  G2  51.091219  19.347020  102.182439
#:> 3     C2   D2  G1  43.362113  13.448023   86.724226
#:> 4     C2   D5  G1  53.854502  20.114795  107.709005
#:> ..   ...  ...  ..        ...        ...         ...
