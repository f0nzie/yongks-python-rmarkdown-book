...
#:> Data of b = 123 
#:> Data of c = 123 
#:> ID of a =  140236496746976 
#:> ID of b =  140236496746976 
#:> ID of c =  140236496746976
```
...
#:> x =  same mem loc 
#:> y =  same mem loc 
#:> id(x) =  140235891222512 
#:> id(y) =  140235891222512
```
...
```
#:> id(a) =  140236421028912 
#:> id(b) =  140236421028912 
#:> a == b   True
```
...
```
#:> ID outside Function:  140235891260384
```
...
```
#:> [1, 2, 3, 4, 5]
#:> ID in Function:       140235891260384
```
...
```
#:> 140235891308416 140235891270752
```
...
#:> Convert to set      :  {'c', 'b', 'e', 'f', 'a', 'd', 'g'} 
#:> Convert back to list:  ['c', 'b', 'e', 'f', 'a', 'd', 'g']
```
...
```
#:> [<function foo at 0x7f8b367ce5f0>, <function bar at 0x7f8b367ce440>]
```
...
```
#:> [<function foo at 0x7f8b367d2dd0>, <function bax at 0x7f8b367d5170>]
```
...
```
#:> [<function bar at 0x7f8b367d2f80>, <function bax at 0x7f8b367d5170>]
```
...
```
#:> datetime.datetime(2020, 10, 30, 12, 2, 3, 987163)
```
...
```
#:> datetime.datetime(2020, 10, 30, 17, 2, 3, 999552)
```
...
```
#:> datetime.datetime(2020, 10, 30, 12, 2, 4, 12044)
```
...
```
#:> datetime.datetime(1999, 10, 30, 12, 2, 4, 105582)
```
...
```
#:> delt+now :  2021-10-30 12:35:19.297096
```
...
#:> 0   C3   D1  G2  60.616361  23.953497
#:> 1   C2   D5  G1  42.245366  22.690627
#:> 2   C3   D5  G1  48.337037  19.488216
#:> 3   C3   D3  G1  55.739492  17.558063
#:> 4   C3   D3  G2  45.800228  21.957972
```
...
#:> 0     C3   D1  G2  60.616361  23.953497  60.616361
#:> 1     C2   D5  G1  42.245366  22.690627  42.245366
#:> 2     C3   D5  G1  48.337037  19.488216  48.337037
#:> 3     C3   D3  G1  55.739492  17.558063  55.739492
#:> 4     C3   D3  G2  45.800228  21.957972  45.800228
#:> ..   ...  ...  ..        ...        ...        ...
#:> 195   C1   D4  G2  54.949772  20.709280  54.949772
#:> 196   C3   D4  G1  48.332087  20.570671  48.332087
#:> 197   C3   D3  G1  55.156775  15.834535  55.156775
#:> 198   C3   D2  G1  54.189089  20.108572  54.189089
#:> 199   C2   D1  G1  49.194352  13.969181  49.194352
#:> 
...
#:> 0     C3   D1  G2  60.616361  23.953497  60.616361  23.953497
#:> 1     C2   D5  G1  42.245366  22.690627  42.245366  22.690627
#:> 2     C3   D5  G1  48.337037  19.488216  48.337037  19.488216
#:> 3     C3   D3  G1  55.739492  17.558063  55.739492  17.558063
#:> 4     C3   D3  G2  45.800228  21.957972  45.800228  21.957972
#:> ..   ...  ...  ..        ...        ...        ...        ...
#:> 195   C1   D4  G2  54.949772  20.709280  54.949772  20.709280
#:> 196   C3   D4  G1  48.332087  20.570671  48.332087  20.570671
#:> 197   C3   D3  G1  55.156775  15.834535  55.156775  15.834535
#:> 198   C3   D2  G1  54.189089  20.108572  54.189089  20.108572
#:> 199   C2   D1  G1  49.194352  13.969181  49.194352  13.969181
#:> 
...
#:> 0     C3   D1  G2  60.616361  23.953497  121.232722
#:> 1     C2   D5  G1  42.245366  22.690627   84.490733
#:> 2     C3   D5  G1  48.337037  19.488216   96.674073
#:> 3     C3   D3  G1  55.739492  17.558063  111.478983
#:> 4     C3   D3  G2  45.800228  21.957972   91.600455
