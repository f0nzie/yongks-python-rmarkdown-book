...
#:> Data of b = 123 
#:> Data of c = 123 
#:> ID of a =  140583902493152 
#:> ID of b =  140583902493152 
#:> ID of c =  140583902493152
```
...
#:> x =  same mem loc 
#:> y =  same mem loc 
#:> id(x) =  140583297007920 
#:> id(y) =  140583297007920
```
...
```
#:> id(a) =  140583826775088 
#:> id(b) =  140583826775088 
#:> a == b   True
```
...
```
#:> ID outside Function:  140583297038448
```
...
```
#:> [1, 2, 3, 4, 5]
#:> ID in Function:       140583297038448
```
...
```
#:> 140583297052096 140583297055712
```
...
#:> Convert to set      :  {'b', 'g', 'f', 'd', 'c', 'e', 'a'} 
#:> Convert back to list:  ['b', 'g', 'f', 'd', 'c', 'e', 'a']
```
...
```
#:> [<function foo at 0x7fdc197b9710>, <function bar at 0x7fdc197b94d0>]
```
...
```
#:> [<function foo at 0x7fdc197c0e60>, <function bax at 0x7fdc197c4200>]
```
...
```
#:> [<function bar at 0x7fdc197c4050>, <function bax at 0x7fdc197c4200>]
```
...
```
#:> datetime.datetime(2020, 10, 30, 12, 49, 28, 59556)
```
...
```
#:> datetime.datetime(2020, 10, 30, 17, 49, 28, 72222)
```
...
```
#:> datetime.datetime(2020, 10, 30, 12, 49, 28, 84551)
```
...
```
#:> datetime.datetime(1999, 10, 30, 12, 49, 28, 172500)
```
...
```
#:> delt+now :  2021-10-30 13:22:43.368299
```
...
#:> 0   C1   D1  G2  54.072811  14.820736
#:> 1   C2   D5  G1  58.485654  17.750280
#:> 2   C1   D4  G2  55.431375  17.454400
#:> 3   C3   D3  G2  50.948846  16.704307
#:> 4   C2   D3  G2  46.563216  23.066399
```
...
#:> 0     C1   D1  G2  54.072811  14.820736  54.072811
#:> 1     C2   D5  G1  58.485654  17.750280  58.485654
#:> 2     C1   D4  G2  55.431375  17.454400  55.431375
#:> 3     C3   D3  G2  50.948846  16.704307  50.948846
#:> 4     C2   D3  G2  46.563216  23.066399  46.563216
#:> ..   ...  ...  ..        ...        ...        ...
#:> 195   C2   D1  G1  51.200660  22.832248  51.200660
#:> 196   C1   D1  G2  43.312574  25.433517  43.312574
#:> 197   C1   D5  G2  47.053106  17.721835  47.053106
#:> 198   C3   D1  G2  53.046221  23.477527  53.046221
#:> 199   C2   D2  G1  56.293039  17.997014  56.293039
#:> 
...
#:> 0     C1   D1  G2  54.072811  14.820736  54.072811  14.820736
#:> 1     C2   D5  G1  58.485654  17.750280  58.485654  17.750280
#:> 2     C1   D4  G2  55.431375  17.454400  55.431375  17.454400
#:> 3     C3   D3  G2  50.948846  16.704307  50.948846  16.704307
#:> 4     C2   D3  G2  46.563216  23.066399  46.563216  23.066399
#:> ..   ...  ...  ..        ...        ...        ...        ...
#:> 195   C2   D1  G1  51.200660  22.832248  51.200660  22.832248
#:> 196   C1   D1  G2  43.312574  25.433517  43.312574  25.433517
#:> 197   C1   D5  G2  47.053106  17.721835  47.053106  17.721835
#:> 198   C3   D1  G2  53.046221  23.477527  53.046221  23.477527
#:> 199   C2   D2  G1  56.293039  17.997014  56.293039  17.997014
#:> 
...
#:> 0     C1   D1  G2  54.072811  14.820736  108.145622
#:> 1     C2   D5  G1  58.485654  17.750280  116.971308
#:> 2     C1   D4  G2  55.431375  17.454400  110.862751
#:> 3     C3   D3  G2  50.948846  16.704307  101.897692
#:> 4     C2   D3  G2  46.563216  23.066399   93.126432
