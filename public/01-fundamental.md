...
#:> Data of b = 123 
#:> Data of c = 123 
#:> ID of a =  140537751099872 
#:> ID of b =  140537751099872 
#:> ID of c =  140537751099872
```
...
#:> x =  same mem loc 
#:> y =  same mem loc 
#:> id(x) =  140537145540400 
#:> id(y) =  140537145540400
```
...
```
#:> id(a) =  140537675381808 
#:> id(b) =  140537675381808 
#:> a == b   True
```
...
```
#:> ID outside Function:  140537277826704
```
...
```
#:> [1, 2, 3, 4, 5]
#:> ID in Function:       140537277826704
```
...
```
#:> 140537145637616 140537145645728
```
...
#:> Convert to set      :  {'f', 'a', 'g', 'd', 'c', 'b', 'e'} 
#:> Convert back to list:  ['f', 'a', 'g', 'd', 'c', 'b', 'e']
```
...
```
#:> [<function foo at 0x7fd15aa4f710>, <function bar at 0x7fd15aa4f4d0>]
```
...
```
#:> [<function foo at 0x7fd15aa54e60>, <function bax at 0x7fd15aa59200>]
```
...
```
#:> [<function bar at 0x7fd15aa59050>, <function bax at 0x7fd15aa59200>]
```
...
```
#:> datetime.datetime(2020, 10, 30, 12, 31, 22, 181417)
```
...
```
#:> datetime.datetime(2020, 10, 30, 17, 31, 22, 195950)
```
...
```
#:> datetime.datetime(2020, 10, 30, 12, 31, 22, 211083)
```
...
```
#:> datetime.datetime(1999, 10, 30, 12, 31, 22, 302046)
```
...
```
#:> delt+now :  2021-10-30 13:04:37.492485
```
...
#:> 0   C2   D3  G1  56.129184  19.938749
#:> 1   C2   D2  G1  50.076701  19.413738
#:> 2   C2   D3  G1  46.945328  18.461744
#:> 3   C1   D2  G2  50.801093  14.805493
#:> 4   C3   D3  G1  52.499825  18.692394
```
...
#:> 0     C2   D3  G1  56.129184  19.938749  56.129184
#:> 1     C2   D2  G1  50.076701  19.413738  50.076701
#:> 2     C2   D3  G1  46.945328  18.461744  46.945328
#:> 3     C1   D2  G2  50.801093  14.805493  50.801093
#:> 4     C3   D3  G1  52.499825  18.692394  52.499825
#:> ..   ...  ...  ..        ...        ...        ...
#:> 195   C1   D3  G1  41.835065  25.215856  41.835065
#:> 196   C2   D2  G2  58.487573  18.184689  58.487573
#:> 197   C2   D1  G1  57.087290  19.848161  57.087290
#:> 198   C3   D4  G2  56.602114  17.610029  56.602114
#:> 199   C1   D2  G1  58.296524  21.433383  58.296524
#:> 
...
#:> 0     C2   D3  G1  56.129184  19.938749  56.129184  19.938749
#:> 1     C2   D2  G1  50.076701  19.413738  50.076701  19.413738
#:> 2     C2   D3  G1  46.945328  18.461744  46.945328  18.461744
#:> 3     C1   D2  G2  50.801093  14.805493  50.801093  14.805493
#:> 4     C3   D3  G1  52.499825  18.692394  52.499825  18.692394
#:> ..   ...  ...  ..        ...        ...        ...        ...
#:> 195   C1   D3  G1  41.835065  25.215856  41.835065  25.215856
#:> 196   C2   D2  G2  58.487573  18.184689  58.487573  18.184689
#:> 197   C2   D1  G1  57.087290  19.848161  57.087290  19.848161
#:> 198   C3   D4  G2  56.602114  17.610029  56.602114  17.610029
#:> 199   C1   D2  G1  58.296524  21.433383  58.296524  21.433383
#:> 
...
#:> 0     C2   D3  G1  56.129184  19.938749  112.258368
#:> 1     C2   D2  G1  50.076701  19.413738  100.153403
#:> 2     C2   D3  G1  46.945328  18.461744   93.890656
#:> 3     C1   D2  G2  50.801093  14.805493  101.602187
#:> 4     C3   D3  G1  52.499825  18.692394  104.999651
