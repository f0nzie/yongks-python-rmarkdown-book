...
#:> Data of b = 123 
#:> Data of c = 123 
#:> ID of a =  139780769782240 
#:> ID of b =  139780769782240 
#:> ID of c =  139780769782240
```
...
#:> x =  same mem loc 
#:> y =  same mem loc 
#:> id(x) =  139780314366960 
#:> id(y) =  139780314366960
```
...
```
#:> id(a) =  139780760685808 
#:> id(b) =  139780760685808 
#:> a == b   True
```
...
```
#:> ID outside Function:  139780474983120
```
...
```
#:> [1, 2, 3, 4, 5]
#:> ID in Function:       139780474983120
```
...
```
#:> 139780314469872 139780314335824
```
...
#:> Convert to set      :  {'g', 'd', 'e', 'b', 'f', 'c', 'a'} 
#:> Convert back to list:  ['g', 'd', 'e', 'b', 'f', 'c', 'a']
```
...
```
#:> [<function foo at 0x7f2123fe3830>, <function bar at 0x7f2123fe3f80>]
```
...
```
#:> [<function foo at 0x7f2123fbe830>, <function bax at 0x7f2123fbe050>]
```
...
```
#:> [<function bar at 0x7f2123fbe200>, <function bax at 0x7f2123fbe050>]
```
...
```
#:> datetime.datetime(2020, 12, 27, 17, 14, 52, 244780)
```
...
```
#:> datetime.datetime(2020, 12, 27, 23, 14, 52, 257624)
```
...
```
#:> datetime.datetime(2020, 12, 27, 17, 14, 52, 271526)
```
...
```
#:> datetime.datetime(1999, 12, 27, 17, 14, 52, 353192)
```
...
```
#:> delt+now :  2021-12-27 17:48:07.538747
```
