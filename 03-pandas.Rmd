...
Two methods of selecting single column:  
- use `DataFrame.ColumnName` - column name must not contain space and dot  
- use `DataFrame['ColumnName']` - column name is a string  

Below example returns the same result (Series)
```{python}
print( 
  df.name,           '\n\n',
  df['name'],        '\n\n',
