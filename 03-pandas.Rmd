...
Each level (header) is an index object, use **`MultiIndex.get_level_values()`** to get each level value.
...
The above is similar to below, using **`MultiIndex.levels`** property.
