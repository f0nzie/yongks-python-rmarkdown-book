...
In the below exmaple, **a and b** refer to the **same memory location**.
...
Note that all object created using this method refer to the **same memory location**.
...
```{python, jupyter_meta = list(code_folding = list())}
b = False
...
```{python, jupyter_meta = list(scrolled = FALSE)}
